...
//            }
//            else if(!uartBufferPLCTran.complete&&uartBufferPLCRecv.complete)
//            {
//                uartBufferPLCTran.lens=uartBufferPLCRecv.lens;
//                uartBufferPLCTran.date=uartBufferPLCRecv.date;
//                IEC1bits.U2TXIE=1;
